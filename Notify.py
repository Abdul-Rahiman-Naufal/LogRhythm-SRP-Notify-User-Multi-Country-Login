...
result = subprocess.run(["powershell", "-Command", "Get-ADUser -Identity "+username+" -Properties EmailAddress | Select-Object -ExpandProperty Name"], capture_output=True).stdout
...
GivenName=""
try:
    GivenName = re.search(pattern, s).group(1)
except Exception:
    pass
...
<html>
  ...
  <body>
    ...
    <p>Dear"""+" "+GivenName+" ("+username+"),"+"""
    <br>
      <br>

      Your user account was logged in from another country. Kindly contact IT Dept if it was not you.
